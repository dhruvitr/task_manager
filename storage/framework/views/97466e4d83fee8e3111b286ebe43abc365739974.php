...
<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 p-3 bg-dark ">
                <ul class="list-group shadow-lg connectedSortable" id="padding-item-drop">
                  <?php if(!empty($tasks) && $tasks->count()): ?>
                    <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li class="list-group-item" item-id="<?php echo e($value->id); ?>">
                        <span class="list-group-item-editable" data-name="<?php echo e($value->name); ?>" data-type="text" data-pk="<?php echo e($value->id); ?>" data-title="Enter name" >
                            <?php echo e($value->name); ?>

                        </span>
                        <span class="float-right"> 
                            <button class="btn btn-sm btn-danger delete" data-id="<?php echo e($value->id); ?>" >DELETE</button>
                        </span>
                      </li>
  ...
  $( function() {
    ...
    $( ".connectedSortable" ).on( "sortupdate", function( event, ui ) {
        ...
        $.ajax({
            url: "<?php echo e(route('sort.task')); ?>",
            method: 'POST',
            headers: {
    ...
    $(".delete").on("click", function(e){
        $.ajax({
            url: "<?php echo e(route('delete.task')); ?>",
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo e(route('create.task')); ?>" method="POST">
...
</html><?php /**PATH D:\xampp_82\htdocs\task_manager\resources\views/tasks.blade.php ENDPATH**/ ?>